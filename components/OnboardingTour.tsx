...
const TOUR_STEPS = [
  {
    ...
    content: 'Asisten produktivitas cerdas Anda. Mari tur singkat 3 fitur utama untuk membantu Anda memulai.',
    position: 'center',
  },
  {
    selector: '[data-tour-id="smart-add-task"]',
    title: 'AI Planner',
    content: 'Ketik atau ucapkan rencana Anda di sini (contoh: "Rapat besok jam 2"). AI akan otomatis menjadwalkannya untuk Anda.',
    position: 'bottom',
  },
  {
    selector: '[data-tour-id="sidebar-nav"]',
    title: 'Navigasi Lengkap',
    content: 'Akses Jurnal Harian, Keuangan, Kalender, dan fitur lainnya melalui menu sidebar ini.',
    position: 'right',
  },
  {
    selector: '[data-tour-id="task-list"]',
    title: 'Kelola Tugas',
    content: 'Klik pada tugas untuk melihat detail, menambah checklist, atau memulai sesi Fokus (Pomodoro).',
    position: 'top',
  },
  {
    selector: null,
    title: 'Anda Siap!',
    content: 'Sekarang Anda siap untuk menjadi lebih produktif. Selamat menggunakan Flowmind!',
    position: 'center',
  },
];
