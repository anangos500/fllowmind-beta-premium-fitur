...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return (
    <div className={`fixed inset-0 bg-black flex justify-center items-center z-[170] p-4 transition-opacity duration-300 ${isAnimatingOut ? 'bg-opacity-0' : 'bg-opacity-50'}`}>
